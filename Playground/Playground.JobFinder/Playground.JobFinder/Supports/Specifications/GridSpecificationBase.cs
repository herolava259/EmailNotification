...
public abstract class GridSpecificationBase<T> : IGridSpecification<T>
{
    ...
    protected virtual void ApplySorting(string sort, bool ascending)
    {
    ...
    protected virtual void ApplyThenBySorting(string sort, bool ascending)
    {
        // TODO: implment ApplyThenBySorting
    }
}